...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | WEI")[0];
}
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| WEI") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('WEI的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
class Cursor {
  ...
  create() {
    ...
    this.scr.innerHTML = `* {cursor: url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8' width='10px' height='10px'><circle cx='4' cy='4' r='4' opacity='1.0' fill='` + colorVal + `'/></svg>") 4 4, auto}`;
  }
...
//  小歪高清壁纸
let waiBizhi = "url(https://source.unsplash.com/random)";
// tuapi 动漫
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://img.gejiba.com/images/57a861c008e94523f949cb48086927dd.jpg);
    --darkmode-bg:url(https://img.gejiba.com/images/b1c4c1d9fb4d7ffe6118055f7bb18052.jpg);
    --mobileday-bg: url(https://img.gejiba.com/images/aa00e0ffdd13ca372a75ba91d521cf9a.jpg);
    --mobilenight-bg: url(https://img.gejiba.com/images/e520a839cfa364fe48bb2564409b63c9.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
